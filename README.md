...
checkout, payments, transactional outbox, the order timeline, the Demo Lab and refunds — on **337
passing tests** (191 domain, 8 architecture, 138 integration against a real PostgreSQL 18 in
